                ...
                <div class="row gutters-10">
            		<div class="col-md-4">
            			<div class="bg-grad-1 text-white rounded-lg mb-4 overflow-hidden">
            				<div class="px-3 pt-3">
                                @if(Session::has('cart'))
                                    <div class="h3 fw-700">{{ count(Session::get('cart'))}} Ürünler</div>
                                @else
                                    <div class="h3 fw-700">0 Ürün</div>
                                @endif
  					            <div class="opacity-50">sepetinde</div>
            				</div>
            		...
            		<div class="col-md-4">
            			<div class="bg-grad-2 text-white rounded-lg mb-4 overflow-hidden">
            				<div class="px-3 pt-3">
                                ...
                                @endphp
              					<div class="h3 fw-700">{{ count(Auth::user()->wishlists)}} Ürünler</div>
              					<div class="opacity-50">Favorilerinizde</div>
			                </div>
        					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
            		...
            		<div class="col-md-4">
            			<div class="bg-grad-3 text-white rounded-lg mb-4 overflow-hidden">
            				<div class="px-3 pt-3">
                                ...
                                @endphp
	        					<div class="h3 fw-700">{{ $total }} Ürünler</div>
	        					<div class="opacity-50">Siparişleriniz</div>
				            </div>
          					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
              ...
              <div class="row gutters-10">
            		<div class="col-md-6">
            			<div class="card">
                            <div class="card-header">
                                <h6 class="mb-0">varsayılan kargo adresi</h6>
                            </div>
    				        <div class="card-body">
                              @if(Auth::user()->addresses != null)
                                  ...
                                  @if($address != null)
                                      <ul class="list-unstyled mb-0">
    					                  <li class=" py-2"><span>Adres : {{ $address->address }}</span></li>
                                          <li class=" py-2"><span>Ülke : {{ $address->country }}</span></li>
                                          <li class=" py-2"><span>Şehir : {{ $address->city }}</span></li>
                                          <li class=" py-2"><span>Posta Kodu : {{ $address->postal_code }}</span></li>
                                          <li class=" py-2"><span>Telefon : {{ $address->phone }}</span></li>
                                      </ul>
                                  @endif
                              @endif
            				</div>
                    ...
                    @if (\App\BusinessSetting::where('type', 'classified_product')->first()->value)
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-header">
                                    <h6 class="mb-0">Satın Alınan Paket</h6>
                                </div>
                                <div class="card-body text-center">
                                    ...
                                    @if($customer_package != null)
                                		...
                                		<p class="mb-1 text-muted">Ürün Yükleme: {{ $customer_package->product_upload }} Zamanlar</p>
                                		<p class="text-muted mb-4">Kalan Ürün Yüklemesi: {{ Auth::user()->remaining_uploads }} Zamanlar</p>
                                        <h5 class="fw-600 mb-3 text-primary">Şu anki paket: {{ $customer_package->getTranslation('name') }}</h5>
                                    @else
                                        <h5 class="fw-600 mb-3 text-primary">Package Not Found</h5>
                                    @endif
                                    <a href="{{ route('customer_packages_list_show') }}" class="btn btn-success d-inline-block">Yükseltme Paketi</a>
                                </div>
                            </div>
                        </div>
                    @endif
