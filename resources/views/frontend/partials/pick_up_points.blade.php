<div class="card-header bg-white py-3">
    <h5 class="heading-6 mb-0">En Yakın Alış Noktasını Seçin</h5>
</div>
@php
...
@if (!empty($admin_products))
    ...
    <label class="mega-radio w-100">
        ...
        <span class="d-block">
            <br><strong>Adres: {{ $pick_up_point->getTranslation('name') }}</strong>
            <br><strong>Adres: {{ $pick_up_point->getTranslation('address') }}</strong>
            <br><strong>Telefon: {{ $pick_up_point->phone }}</strong>
        </span>
    </label>
    @endforeach
@endif
