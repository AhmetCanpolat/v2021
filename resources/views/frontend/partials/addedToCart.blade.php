<div class="modal-body p-4 added-to-cart">
    ...
    <div class="text-center">
        <button class="btn btn-outline-primary mb-3 mb-sm-0" data-dismiss="modal">Mağazaya geri dön</button>
        <a href="{{ route('cart') }}" class="btn btn-primary mb-3 mb-sm-0">Ödemeye devam et</a>
    </div>
</div>
